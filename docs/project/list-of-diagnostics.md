...
|  __`SYSLIB0050`__ | Formatter-based serialization is obsolete and should not be used. See https://aka.ms/dotnet-warnings/syslib0050 for more information. |
|  __`SYSLIB0051`__ | This API supports obsolete formatter-based serialization. It should not be called or extended by application code. See https://aka.ms/dotnet-warnings/syslib0051 for more information. |

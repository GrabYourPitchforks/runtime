...
If you wish to run the test under a debugger (e.g. [WinDbg](https://msdn.microsoft.com/library/windows/hardware/ff551063(v=vs.85).aspx)), append `-debug <debuggerFullPath>` to the test command. For example:

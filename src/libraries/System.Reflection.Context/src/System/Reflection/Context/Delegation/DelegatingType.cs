...
namespace System.Reflection.Context.Delegation
{
    internal abstract class DelegatingType : TypeInfo
    {
        ...
        [Obsolete("Formatter-based serialization is obsolete and should not be used. See https://aka.ms/dotnet-warnings/syslib0050 for more information.", DiagnosticId = "SYSLIB0050", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
#endif

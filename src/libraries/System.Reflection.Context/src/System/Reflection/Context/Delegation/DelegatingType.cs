...
namespace System.Reflection.Context.Delegation
{
    internal abstract class DelegatingType : TypeInfo
    {
        ...
        [Obsolete("Legacy formatter-based serialization is obsolete and should not be used. See https://aka.ms/binaryformatter for more information.", DiagnosticId = "SYSLIB0050", UrlFormat = "https://aka.ms/dotnet-warnings/{0}")]
#endif

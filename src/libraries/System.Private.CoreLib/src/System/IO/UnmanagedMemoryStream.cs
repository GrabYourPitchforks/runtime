...
namespace System.IO
{
    ...
    public class UnmanagedMemoryStream : Stream
    {
        ...
        internal int ReadCore(Span<byte> buffer)
        {
            ...
            unsafe
            {
                ref byte pBuffer = ref MemoryMarshal.GetReference(buffer);
                ...
                if (_buffer != null)
                {
                    ...
                    {
                        _buffer.AcquirePointer(ref pointer);
                        Buffer.Memmove(ref pBuffer, ref *(pointer + pos + _offset), (uint)nInt);
                    }
                    finally
                    {
                        if (pointer != null)
                ...
                {
                    Buffer.Memmove(ref pBuffer, ref _mem[pos], (uint)nInt);
                }
            }
            Interlocked.Exchange(ref _position, pos + n);
            return nInt;
        ...
        internal unsafe void WriteCore(ReadOnlySpan<byte> buffer)
        {
            ...
            if (_buffer != null)
            {
                ...
                {
                    _buffer.AcquirePointer(ref pointer);
                    Buffer.Memmove(ref *(pointer + pos + _offset), ref pBuffer, (uint)buffer.Length);
                }
                finally
                {
                    if (pointer != null)
            ...
            {
                Buffer.Memmove(ref _mem[pos], ref pBuffer, (uint)buffer.Length);
            }

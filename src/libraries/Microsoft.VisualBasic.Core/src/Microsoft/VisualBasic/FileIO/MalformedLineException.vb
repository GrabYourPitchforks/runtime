...
Namespace Microsoft.VisualBasic.FileIO
    ...
    Public Class MalformedLineException
        ...
        <Obsolete("Legacy formatter-based serialization (IMPL) is obsolete and should not be used. See https://aka.ms/binaryformatter for more information.", DiagnosticId:="SYSLIB0051", UrlFormat:="https://aka.ms/dotnet-warnings/{0}")>

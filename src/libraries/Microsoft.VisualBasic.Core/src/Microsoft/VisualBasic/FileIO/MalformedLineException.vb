...
Namespace Microsoft.VisualBasic.FileIO
    ...
    Public Class MalformedLineException
        ...
        <Obsolete("This API supports obsolete formatter-based serialization. It should not be called or extended by application code. See https://aka.ms/dotnet-warnings/syslib0051 for more information.", DiagnosticId:="SYSLIB0051", UrlFormat:="https://aka.ms/dotnet-warnings/{0}")>

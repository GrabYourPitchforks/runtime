...
extern FCDECL2(Object*, JIT_NewArr1Uninit, CORINFO_CLASS_HANDLE arrayMT, INT_PTR size);
...
EXTERN_C FCDECL2(Object*, JIT_NewArr1VCUninit_MP_InlineGetThread, CORINFO_CLASS_HANDLE arrayMT, INT_PTR size);
